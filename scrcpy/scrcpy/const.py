...
TYPE_SET_DISPLAY_POWER = 10  # 重命名：从 TYPE_SET_SCREEN_POWER_MODE
TYPE_ROTATE_DEVICE = 11
TYPE_UHID_CREATE = 12  # 新增
TYPE_UHID_INPUT = 13   # 新增
TYPE_UHID_DESTROY = 14 # 新增
TYPE_OPEN_HARD_KEYBOARD_SETTINGS = 15  # 新增
TYPE_START_APP = 16    # 新增
...
TYPE_DEVICE_CLIPBOARD = 0
TYPE_DEVICE_ACK_CLIPBOARD = 1
TYPE_DEVICE_UHID_OUTPUT = 2
